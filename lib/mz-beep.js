 ...
 * @constructor
 * @param {MZ700Js} mz700js MZ-700 emulator UI side instance
 * @param {AudioContext} audioContext The audio context instance.
 */
function MZBeep(mz700js, audioContext) {
    ...
    mz700js.subscribe("startSound", freq => this.startSound(freq[0]));
    mz700js.subscribe("stopSound", () => this.stopSound());
