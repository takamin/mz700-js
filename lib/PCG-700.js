...
/**
 * Create PCG700.
 * @param {MZ_MMIO} mmio A memory mapped I/O system.
 * @param {mz700scrn} screen A screen object.
 * @returns {PCG700} PCG-700 emulator
 */
PCG700.create = (mmio, screen) => {
    return new PCG700(mmio, screen);
};
